    ...
    <div className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 border border-gray-100 flex flex-col">
      <div className="relative aspect-square overflow-hidden bg-gray-50">
        ...
        <div className="absolute top-4 right-4 flex flex-col gap-2">
          <button 
            ...
            className={`w-10 h-10 rounded-full flex items-center justify-center shadow-md transition-colors ${liked ? 'bg-pink-500 text-white' : 'bg-white text-gray-400 hover:text-pink-500'}`}>
      ...
      <div className="p-5 flex flex-col flex-1">
        <div className="mb-2">
          ...
          <h3 className="text-lg font-serif text-gray-800 leading-tight">{product.nombre}</h3>
        </div>
        ...
        <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-50">
          ...
          <button 
            ...
            className="bg-pastel-pink text-white px-4 py-2 rounded-full text-sm font-semibold hover:bg-pink-400 transition transform hover:-translate-y-1 active:scale-95 shadow-lg">
            Añadir
          </button>
        </div>
      </div>
